...
<body>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="<?php echo e(route('admin.home')); ?>" class="logo">
					<img src="<?php echo e(asset('assets/img/logo.svg')); ?>" alt="navbar brand" class="navbar-brand">
				</a>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									<li>
										<a href="<?php echo e(route('karyawan.tambah')); ?>">
											<span class="sub-item">Tambah Karyawan</span>
										</a>
									</li>
									<li>
										<a href="<?php echo e(route('karyawan.lihat')); ?>">
	...
	<script src="<?php echo e(asset('js/app_absensi.js')); ?>"></script>
</body>
</html><?php /**PATH D:\My Projects\absensi_app\resources\views/layouts/admin.blade.php ENDPATH**/ ?>